...
public class Converte {
    ...
    private static int prioridade(final String operador) {
        int pri = 0;
        switch (operador) {
            case "+":
            case "-":
    ...
    public static String posFixa(final String sentenca) {
        // cria saida vazia
        String posFixa = "";
        // cria pilha vazia
        ...
        final ArrayList<String> infixa = lexico(sentenca);
        final int n = infixa.size(); // n armazena o numero de tokens a ser analisado
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (infixa.get(i)) {
                ...
                case "/":
                    /*
                     * 2.b.i. Enquanto a pilha não estiver vazia e no topo existir um operador com
                     * prioridade <= ao encontrado, desempilha o operador e coloca na saída;
                     */
                ...
                case ")":
                    /*
                     * 2.d - encontrou o fecha-parentese '(' é hora de desempilhar e adicionar o
                     * operador a saida até encontrar o parentese correspondente ao abre_parentese
                     */
